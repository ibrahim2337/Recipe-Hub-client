...
const Login = () => {
    ...
    <div className="px-6 py-4">
        ...
        <h3 className="mt-3 text-xl text-center font-bold dark:text-gray-900">Welcome Back</h3>

        <p className="mt-1 text-center font-bold dark:text-gray-700">Login or create account</p>
        ...
        <form>
            ...
            <div className="flex items-center justify-between mt-4">
                <a href="#" className="text-md text-gray-600 dark:text-blue-800 hover:text-gray-500">Forget Password?</a>
